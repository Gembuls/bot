...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    let dot = TICK_N % 2 === 0 ? 'INDONATION' : 'ROLEPLAY';
    let embed = new Discord.RichEmbed()
    .setAuthor("INDONATION STATUS", "https://cdn.discordapp.com/attachments/802420949525200896/846306426586267658/icontab.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ GEMBUL GANTENG' : '⚫ GEMBUL GANTENG')
    .setTimestamp(new Date())
    .addField('\n\u200b\nBAGAI MANA CARA MENJADI GANTENG SUBSCIRBE GEMBUL SAJA\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('INDONATION',{'url':'https://www.youtube.com/channel/UCkqMw81s2aw7bYO-U2YhD7w?view_as=subscriber','type':'STREAMING'});
